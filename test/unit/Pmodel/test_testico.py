...
class TestMosqDevJ:
    ...
    def test_typical_temperatures(self, typical_temperature_array):
    ...
    def test_edge_case_temperatures(self):
    ...
    def test_large_temperatures(self):
    ...
    def test_known_matrix_output(self):
...
class TestMosqDevI:
    """Test suite for mosq_dev_i()"""

    # -------------------------------------------------------------------------
    # Typical cases
    # -------------------------------------------------------------------------

    def test_typical_temperatures(self, typical_temperature_array_i):
...
class TestMosqDevE:
    ...
    def test_typical_temperatures(self, typical_temperature_array_e):
    ...
    def test_multidimensional_input(self):
        ...
        assert result.shape == temps.shape
        assert np.all(
            np.isfinite(result[np.nonzero(temps <= CONSTANTS_MOSQUITO_E["Tm"])])
        )
...
# =============================================================================
# TESTS: carrying_capacity
# =============================================================================


class TestCarryingCapacity:
    """Test suite for carrying_capacity()"""

    # -------------------------------------------------------------------------
    # Typical cases
    # -------------------------------------------------------------------------

    def test_time_independent_population(
        self, rainfall_data_fixture, population_data_time_independent_fixture
    ):
        """
    ...
    def test_time_dependent_population(
        self, rainfall_data_fixture, population_data_time_dependent_fixture
    ):
    ...
    def test_single_time_step(
        self, single_time_step_rainfall_fixture, single_time_step_population_fixture
    ):
    ...
    def test_with_zeros(self, zero_rainfall_fixture, zero_population_fixture):
    ...
    # Note: No error condition tests currently implemented for this function
    # Consider adding tests for:
    # - Mismatched dimensions between rainfall and population
    # - Invalid data types
