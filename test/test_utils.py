...
def test_validate_spatial_alignment_missing_latitude():
    ...
    with pytest.raises(ValueError, match="Input DataArrays must have a 'latitude' coordinate."):
        validate_spatial_alignment(arr1, arr2)
...
def test_validate_spatial_alignment_missing_longitude():
    ...
    with pytest.raises(ValueError, match="Input DataArrays must have a 'longitude' coordinate."):
        validate_spatial_alignment(arr1, arr2)
